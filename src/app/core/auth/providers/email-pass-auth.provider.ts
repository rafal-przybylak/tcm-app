...
export class NbEmailPassAuthProvider extends NbAbstractAuthProvider {
  ...
  constructor(private loopBackAuth:LoopBackAuth, protected http: HttpClient, private route: ActivatedRoute, private autApi: UserApi, private router: Router, private platformLocation: PlatformLocation) {
    super();
    ...
    return this.autApi.login(data)
      ...
      .catch((res) => {
        ...
        if (res instanceof HttpErrorResponse) {
          ...
          errors.push('Nieprawidłowy login lub hasło.');
        }
  ...
  register(data?: any): Observable<NbAuthResult> {
    ...
    return this.autApi.create(data)
      .map((res) => {
  ...
  requestPassword(data?: any): Observable<NbAuthResult> {
    ...
    baseUrl += "/auth-reset-pass";
    data['callBackUrl'] = baseUrl;
    return this.autApi.resetPassword(data)
      .map((res) => {
  ...
  resetPassword(data: any = {}): Observable<NbAuthResult> {
    ...
    console.log(_thiss.route.snapshot.queryParams[tokenKey]);
    return this.autApi.setPassword(data.password, (header: Headers): Headers => {
      header.set('Authorization', LoopBackConfig.getAuthPrefix() + (_thiss.route.snapshot.queryParams[tokenKey]==undefined? this.loopBackAuth.getAccessTokenId(): _thiss.route.snapshot.queryParams[tokenKey]));
      return header;
    }
    )
      .map((res) => {
  ...
  mailConfirm(data: any = {}): Observable<NbAuthResult> {
    const tokenKey = this.getConfigValue('resetPass.resetPasswordTokenKey');
    var _thiss = this;
  ...
  getUserRole(): Observable<NbAuthResult> {
